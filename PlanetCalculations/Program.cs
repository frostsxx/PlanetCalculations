    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if (planet == 1)
            {
                ...
                Console.WriteLine("Your age on Mercury would be: " + newMercuryAge + " years old.");
            }

            else if (planet == 2)
            {
                Console.WriteLine("Your new age on Earth would be: " + newEarthAgeVenus + " years old.");
                Console.WriteLine("Your age on Venus would be: " + newVenusAge + " years old.");
            }
            ...
            else if (planet == 4)
            {
                ...
                Console.WriteLine("Your age on Mars would be: " + newMarsAge + " years old.");
            }

            else if (planet == 5)
            {
                Console.WriteLine("Your new age on Earth would be: " + newEarthAgeJupiter + " years old.");
                Console.WriteLine("Your age on Jupiter would be: " + newJupiterAge + " years old.");
            }

            else if (planet == 6)
            {
                Console.WriteLine("Your new age on Earth would be: " + newEarthAgeSaturn + " years old.");
                Console.WriteLine("Your age on Saturn would be: " + newSaturnAge + " years old.");
            }

            else if (planet == 7)
            {
                Console.WriteLine("Your new age on Earth would be: " + newEarthAgeUranus + " years old.");
                Console.WriteLine("Your age on Uranus would be: " + newUranusAge + " years old.");
            }

            else if (planet == 8)
            {
                Console.WriteLine("Your new age on Earth would be: " + newEarthAgeNeptune + " years old.");
                Console.WriteLine("Your age on Neptune would be: " + newNeptuneAge + " years old.");
            }
